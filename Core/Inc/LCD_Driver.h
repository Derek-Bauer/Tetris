...
void mainMenu(void);
void drawHero(uint16_t x, uint16_t y);
void drawOrangeRicky(uint16_t x, uint16_t y);
void drawBlueRicky(uint16_t x, uint16_t y);
void drawRhodeIslandZ(uint16_t x, uint16_t y);
void drawClevelandZ(uint16_t x, uint16_t y);
void drawTeewee(uint16_t x, uint16_t y);
void drawSmashboy(uint16_t x, uint16_t y);
